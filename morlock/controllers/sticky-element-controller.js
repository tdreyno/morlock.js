...
var { getOption, partial, forEach, call,
      functionBind, isFunction } = require('morlock/core/util');
var { getStyle, setStyle, setStyles, addClass, removeClass, insertBefore,
      documentScrollY, detachElement } = require('morlock/core/dom');
...
var onScroll = curry(function onScroll_(stickyElement, scrollY) {
