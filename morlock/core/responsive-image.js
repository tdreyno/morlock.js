...
var { flip, mapObj } = require('ramda');
var { map, sortBy, parseInteger, getOption, partial, setKey } = require('morlock/core/util');
var { setStyle, getRect } = require('morlock/core/dom');
...
function create(imageMap) {
  ...
  mapObj(flip(setKey(image)), imageMap);
...
module.exports = { create, createFromElement, update, checkVisibility };
